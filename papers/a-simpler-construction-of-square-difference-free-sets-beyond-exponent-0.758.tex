...
Krachun's recent construction crosses the integer three-quarter barrier
...
pdflatex -interaction=nonstopmode -halt-on-error \
  -no-shell-escape \
  a-simpler-construction-of-square-difference-free-sets-beyond-exponent-0.758.tex
\end{lstlisting}
