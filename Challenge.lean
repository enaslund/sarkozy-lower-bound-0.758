...
The principal theorem is a general asymptotic interval-moment criterion.
Ordered intervals on finite alphabets in coprime square bases, with a strict
...
The two deliberate placeholders below are only the statement format; both
corresponding Solution declarations are proved without extra axioms.
-/
